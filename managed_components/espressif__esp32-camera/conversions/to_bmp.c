...
// RGB565 output from the external TJpgDec configuration needs a larger pool
// than the ROM RGB888 path.  Keep it internal for deterministic decode speed.
static uint8_t work[6144];
